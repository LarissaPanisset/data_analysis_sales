...
**Autor:** Larissa Panisset

**Função:** Analista de Dados Júnior
...
1. **Organização dos Dados:** Estruturação das informações em tabelas comparativas
2. **Cálculo de Métricas:** Taxas de crescimento e variações percentuais
3. **Visualização:** Criação de gráficos de barras comparativos e gráficos de crescimento
4. **Análise Estratégica:** Identificar padrões e oportunidades

**Ferramentas Utilizadas:** Excel

- Planilhas para organização e cálculos
- Ferramentas de visualização para os gráficos
